                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
<?php $sql = "SELECT  tblbooks.pdf,
tblbooks.BookName,tblbooks.no_of_copies,tblcategory.CategoryName,tblauthors.AuthorName,tblbooks.ISBNNumber,
tblbooks.BookPrice,tblbooks.status,tblbooks.id  as bookid from  tblbooks join tblcategory on tblcategory.id=tblbooks.CatId join tblauthors on tblauthors.id=tblbooks.AuthorId ";
    $query = $dbh->prepare($sql);
    $query->execute();
...
{ ?>                                      
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center"><?php echo htmlentities($result->BookPrice); ?></td>
                                             ...
                                             <a 
                                              target="_blank"
                                             href="<?php echo "./uploads/".$result->pdf 
