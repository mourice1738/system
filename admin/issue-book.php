...
$sql="INSERT INTO  tblissuedbookdetails(StudentID,BookId,no_of_copies) VALUES(:studentid,:bookid,:no_of_copies)";
...
<input class="form-control" type="text" name="no_of_copies" id="get_no_of_copies"   required="required" />
</div>
 </div>
